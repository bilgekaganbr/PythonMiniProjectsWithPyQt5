...
class Window(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        #add components to the vertical box layout so that username, password, and the label be in the middle and buttons
        #be at the bottom
        v_box.addStretch()
        ...
        #add vertical box layout to the horizontal box layout so that all components be in the middle
        h_box.addStretch()
    ...
    def register(self):
        ...
        if len(data) != 0:
            ...
            self.text_field.setText("User already exists...\nYou can login...")
            ...
            self.text_field.setText("Registration successful...\nYou can login...")
    ...
    def login(self):
        ...
        if len(data) == 0:
            ...
            self.text_field.setText("User not found...\nPlease try again...")

        else:

            self.text_field.setText("Welcome " + usern)
